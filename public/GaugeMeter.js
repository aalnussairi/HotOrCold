    ...
    $.fn.gaugeMeter = function (t) {
        ...
        return this.each(function () {
            ...
            function createSpanTag(t) {
                ...
                var fs = 0; //option.width < 1 || isNaN(option.width) ? option.size / 20 : option.width;
                if (screenWidth < 576) {
                    fs = 64;
            ...
            function drawGauge(a) {
                ...
                if (M > 100) M = 100;
                var screenWidth = $(window).width();
                var lw = 0; //option.width < 1 || isNaN(option.width) ? option.size / 20 : option.width;
                if (screenWidth < 576) {
                    lw = 20;
                } else if (screenWidth >= 576 && screenWidth < 768) {
                    lw = 32;
                ...
                if ($(window).width())
                    if (screenRender) g.clearRect(0, 0, b.width, b.height);
                g.beginPath();
                g.arc(m, v, x, G, k, !1);
                if (s) {
            ...
            if (
                Number.isInteger(option.used) &&
                Number.isInteger(option.total)
            ) {
                var u = option.used;
                var t = option.total;
            ...
            var screenRender = 0;
            if (screenWidth < 576) {
                screenRender = (option.size / 100) * $(window).width() - 30;
            } else if (screenWidth >= 576 && screenWidth < 768) {
                screenRender = 320;
            } else if (screenWidth >= 768 && screenWidth < 992) {
                screenRender = 400;
            ...
            $(this).width(screenRender);
            var b = $("<canvas></canvas>")
                    .attr({
                        width: screenRender + "px",
                        height: screenRender + "px",
                    })
                    .get(0),
                g = b.getContext("2d"),
                m = b.width / 2,
